...
# QGIS Ledger <img src="icon.png" width="64" align="right">
...
4.4.0: IT: Toolbar compatta di default (mostra solo l'icona del Centro Comandi); nuovo interruttore "Mostra tutti i pulsanti nella toolbar" per ripristinare la toolbar completa. Aggiunto il selettore di lingua (7 lingue) direttamente nel Centro Comandi con traduzione al volo. Tutte le nuove stringhe tradotte in tutte le lingue supportate (en, de, fr, pt-BR, zh-SG, hi-IN, ms). README aggiornato. / EN: Compact toolbar by default (shows only the Command Center icon); new "Show all buttons in the toolbar" switch to restore the full toolbar. Added the language selector (7 languages) directly inside the Command Center with on-the-fly translation. All new strings translated into every supported language (en, de, fr, pt-BR, zh-SG, hi-IN, ms). README updated.
...
<div align="center">
Sviluppato da <b>Dott. Sarino Alfonso Grande</b><br>
🌐 <a href="https://sinocloud.it">SinoCloud.it</a>
</div>
